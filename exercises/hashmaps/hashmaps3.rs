...
fn build_scores_table(results: String) -> HashMap<String, Team> {
    ...
    for r in results.lines() {
        ...
        if scores.contains_key(&team_1_name) {
            ...
            scores.insert(team_1_name, Team {goals_conceded: team_2_score + team.goals_conceded, goals_scored: team_1_score + team.goals_scored});
        } else {
        ...
        if scores.contains_key(&team_2_name) {
            ...
            scores.insert(team_2_name, Team {goals_conceded: team_1_score + team.goals_conceded, goals_scored: team_2_score + team.goals_scored});
        } else {
